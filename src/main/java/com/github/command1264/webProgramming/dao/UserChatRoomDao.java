...
//                Printer.println("ErrorChatRoomName: " + chatRoomName);
    ...
    public @NotNull ReturnJsonObject modifyUserChatRoomUsers(String chatRoomName, String usersListStr) {
        ...
        if (usersListStr == null) {
            returnJsonObject.setSuccess(false);
            returnJsonObject.setErrorMessage(ErrorType.cantFindUsers.getMessage());
            return returnJsonObject;
        }
        ...
        try {
            ...
            returnJsonObject.setSuccessAndErrorMessage(ErrorType.cantFindChatRoom.getMessage());
            return returnJsonObject;
        }
        ...
        if (userIds.size() != 1) {
            returnJsonObject.setSuccessAndErrorMessage(ErrorType.usersHasMulti.getMessage());
            return returnJsonObject;
        }
        ...
        try {
            ...
            returnJsonObject.setSuccessAndErrorMessage(ErrorType.usersSaveFailed.getMessage());
            return returnJsonObject;
        }
